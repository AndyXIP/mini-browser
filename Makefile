...
APP = app/src/main.cpp app/src/window.cpp app/src/browser.cpp app/src/searchbar.cpp app/src/http_client.cpp app/src/content_view.cpp app/src/html_parser.cpp
TARGET = bin/main
